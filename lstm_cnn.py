...
class LSTM_CNN(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,num_hidden=100):
        ...
        self.embedded = tf.cast(self.embedded, tf.float32)
        embedding_size = word_embedding.shape[1]
        print('embedding_size {}'.format(embedding_size))


        #2. LSTM LAYER ######################################################################
        self.lstm_cell = tf.contrib.rnn.LSTMCell(embedding_size,state_is_tuple=True)
        #self.h_drop_exp = tf.expand_dims(self.h_drop,-1)
        self.lstm_out,self.lstm_state = tf.nn.dynamic_rnn(self.lstm_cell,self.embedded,dtype=tf.float32)
        #embed()
...
class LSTM_CNN_self(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
                 num_hidden=100):
        # PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, [None, sequence_length], name="input_x")  # X - The Data
...
class LSTMCNN_weighttloss(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
                 num_hidden=100):
        # PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, [None, sequence_length], name="input_x")  # X - The Data
...
class LSTM_CNN_born_weight(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
                 num_hidden=100):
        # PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, [None, sequence_length], name="input_x")  # X - The Data
        self.input_ypre = tf.placeholder(tf.float32, [None, num_classes], name="input_ypre")
        self.input_ytrue = tf.placeholder(tf.float32, [None, num_classes], name="input_yture")
        self.input_yw = tf.placeholder(tf.float32, [None, num_classes], name="input_yw")
        self.dropout_keep_prob = tf.placeholder(tf.float32, name="dropout_keep_prob")  # Dropout
...
class LSTM_CNN_born_weight(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
        ...
        with tf.name_scope("accuracy"):
            ...
            correct_predictions2 = tf.equal(self.predictions2, tf.argmax(self.input_ytrue, 1))
            self.accuracy2 = tf.reduce_mean(tf.cast(correct_predictions2, "float"), name="accuracy2")
class LSTM_CNN_born_learnweight(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
                 num_hidden=100):
        # PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, [None, sequence_length], name="input_x")  # X - The Data
        ...
        with tf.name_scope("accuracy"):
            ...
            correct_predictions2 = tf.equal(self.predictions2, tf.argmax(self.input_ytrue, 1))
            self.accuracy2 = tf.reduce_mean(tf.cast(correct_predictions2, "float"), name="accuracy2")
class LSTMCNN_learn_weighttloss(object):
    def __init__(self, sequence_length, num_classes, word_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0,
                 num_hidden=100):
        # PLACEHOLDERS
        self.input_x = tf.placeholder(tf.int32, [None, sequence_length], name="input_x")  # X - The Data
